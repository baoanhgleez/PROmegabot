...
----------------------
    ...
    ["Route 27"] = {
        ["Route 27_A"] = {{0, 13, 62, 35}, {63, 25, 74, 29}, {63, 31, 90, 36}}, -- left
        ["Route 27_B"] = {{63, 14, 74, 24}, {75, 11, 90, 29}, {91, 7, 217, 36}} -- right
    },
    ["Mt. Moon B1F"] = {
        ["Mt. Moon B1F_A"] = {{17, 14, 25, 34}, {26, 29, 45, 34}}, -- left
        ["Mt. Moon B1F_B"] = {{30, 17, 44, 22}}, -- topleft
        ["Mt. Moon B1F_C"] = {{55, 17, 67, 22}}, -- topright
        ["Mt. Moon B1F_D"] = {{53, 29, 77, 34}, {73, 15, 77, 28}} -- right
    },
    ["Mt. Moon B2F"] = {
        ["Mt. Moon B2F_A"] = {{37, 20, 39, 41}, {40, 34, 70, 46}, {53, 47, 71, 71}, {16, 62, 52, 70}, {16, 42, 22, 61}, {14, 18, 31, 41}}, -- Main path
        ["Mt. Moon B2F_B"] = {{40, 20, 67, 33}}, -- Top side Dig cave
        ["Mt. Moon B2F_C"] = {{28, 48, 48, 56}} -- Middle dig Cave
    },
    ["Cerulean City"] = {
    ...
    ["Cerulean Cave 1F"] = {
        ["Cerulean Cave 1F_A"] = {{16, 9, 58, 16}, {12, 17, 58, 18}, {9, 19, 58, 20}, {9, 21, 51, 24}, {58, 21, 58, 24}, {9, 25, 58, 38}}, --entrance
    ...
    ["Cerulean Cave 2F"] = {
        ["Cerulean Cave 2F_A"] = {{36, 27, 38, 29}, {9, 18, 28, 20}, {24, 24, 35, 39}, {24, 21, 28, 23}, {34, 7, 35, 25}, {8, 7, 27, 14}, {23, 7, 28, 7}, {23, 36, 23, 36}, {8, 38, 29, 40}, {8, 20, 8, 37}, {9, 28, 15, 30}, {20, 14, 27, 14}}, --access from 1F_A and B1F
    ...
    ["Route 24"] = {
        ["Route 24_A"] = {{6, 0, 12, 31}}, -- left
        ["Route 24_B"] = {{14, 0, 15, 31}}, -- middle
        ["Route 24_C"] = {{22, 0, 28, 31}} -- right
    },
    ["Route 10"] = {
        ["Route 10_A"] = {{10, 0, 24, 11}}, -- Pokecenter side
        ["Route 10_B"] = {{8, 22, 30, 34}, {27, 0, 30, 21}}, -- PowerPlant side
        ["Route 10_C"] = {{2, 44, 32, 71}} -- lavender town side
    },
    ["Rock Tunnel 1"] = {
        ["Rock Tunnel 1_A"] = {{29, 18, 37, 18}, {33, 5, 45, 17}, {31, 14, 32, 14}}, -- top right, route 10_A
        ["Rock Tunnel 1_B"] = {{6, 5, 30, 16}, {8, 17, 19, 17}, {31, 9, 31, 12}}, -- top left, path
        ["Rock Tunnel 1_C"] = {{6, 18, 37, 31},{21, 17, 26, 17}} -- bottom, route 10_C
    },
    ["Rock Tunnel 2"] = {
    ...
    ["Pokemon Tower B3"] = {
        ...
        ["Pokemon Tower B3_C"] = {{21, 20, 24, 23}, {20, 22, 20, 23}} -- right
    },
    ["Pokemon Tower B10"] = {
        ["Pokemon Tower B10_A"] = {{17, 16, 20, 23}, {21, 16, 21, 21}, {22, 16, 24, 19}}, -- left + top
        ["Pokemon Tower B10_B"] = {{21, 21, 22, 23}, {23, 20, 24, 23}} -- right
    },
    ["Pokemon Tower B9"] = {
        ["Pokemon Tower B9_A"] = {{17, 16, 19, 23}}, -- left
        ["Pokemon Tower B9_B"] = {{20, 16, 24, 23}} -- right
    },
    ["Pokemon Tower B17"] = {
        ["Pokemon Tower B17_A"] = {{17, 16, 24, 19}, {22, 20, 24, 23}}, -- top and right
        ["Pokemon Tower B17_B"] = {{17, 21, 20, 23}} -- bottom left
    },
    ["Pokemon Tower B19"] = {
        ["Pokemon Tower B19_A"] = {{18, 17, 20, 19}}, -- top left
        ["Pokemon Tower B19_B"] = {{17, 20, 24, 23}}, -- bottom
        ["Pokemon Tower B19_C"] = {{22, 17, 24, 19}} -- right
    },
    ["Pokemon Tower B20"] = {
    ...
    ["Seafoam B2F"] = {
        ["Seafoam B2F_A"] = {{9, 21, 21, 31}}, -- bottom left
        ["Seafoam B2F_B"] = {{23, 21, 30, 31}, {31, 29, 35, 31}}, -- middle left, before jump
        ["Seafoam B2F_C"] = {{34, 17, 40, 25}, {41, 23, 58, 25}, {59, 22, 64, 28}}, -- middle isolated
        ["Seafoam B2F_D"] = {{36, 27, 55, 32}, {56, 31, 66, 32}, {67, 18, 67, 31}, {44, 11, 66, 21}, {23, 8, 43, 15}, {12, 12, 22, 20}, {23, 16, 31, 19}} -- main path, top, right, bottom
    },
    ["Seafoam B3F"] = {
        ["Seafoam B3F_A"] = {{14, 24, 16, 25}, {10, 26, 16, 32}, {17, 29, 30, 31}}, -- left, below water part
        ["Seafoam B3F_B"] = {{9, 6, 10, 26}, {11, 6, 13, 25}, {14, 6, 15, 23}, {16, 6, 21, 13}}, -- left, water part
        ["Seafoam B3F_C"] = {{60, 26, 67, 31}}, -- bottom right
        ["Seafoam B3F_D"] = {{27, 18, 32, 18}, {33, 17, 36, 21}, {37, 14, 44, 21}, {42, 22, 44, 24}}, -- upper middler
        ["Seafoam B3F_E"] = {{32, 15, 35, 16}, {23, 12, 31, 17}, {17, 15, 22, 28}, {23, 20, 31, 28}, {32, 23, 40, 25}, {39, 26, 45, 29}, {46, 6, 59, 29}, {60, 14, 66, 25}, {23, 18, 25, 19}} -- main cave area
    },
    ["Seafoam B4F"] = {
        ["Seafoam B4F_A"] = {{8, 6, 15, 11}, {9, 12, 13, 21}, {9, 22, 10, 29}, {9, 30, 13, 35}, {14, 33, 67, 35}, {28, 30, 32, 32}, {34, 25, 45, 32}, {60, 25, 68, 32}, {68, 17, 71, 24}}, -- left bottom
        ["Seafoam B4F_B"] = {{17, 7, 18, 9}, {19, 7, 32, 8}, {33, 7, 34, 15}, {35, 6, 48, 14}, {49, 6, 50, 22}, {51, 7, 54, 16}, {55, 7, 63, 8}, {63, 7, 66, 24}, {62, 14, 63, 24}, {59, 22, 61, 24}}, -- dead end
        ["Seafoam B4F_C"] = {{11, 22, 13, 29}, {14, 12, 19, 31}, {20, 9, 28, 31}, {29, 9, 32, 29}, {33, 16, 33, 24}, {34, 15, 48, 24}, {47, 25, 48, 30}}, -- middle, double stairs path
        ["Seafoam B4F_D"] = {{50, 23, 57, 32}, {51, 17, 58, 22}, {59, 17, 60, 20}, {56, 9, 62, 16}} -- nurse platform
    },
    ["Route 18"] = {
        ["Route 18_A"] = {{6, 0, 29, 25}}, -- Left
        ["Route 18_B"] = {{30, 14, 50, 23}} -- Right
    },
    ["Route 16"] = {
        ["Route 16_A"] = {{25, 9, 64, 40}}, -- left
        ["Route 16_B"] = {{70, 3, 90, 20}} -- Right
    },
    ["Victory Road Kanto 2F"] = {
        ["Victory Road Kanto 2F_A"] = {{10, 8, 29, 30}, {30, 19, 44, 22}, {40, 23, 58, 26}, {50, 27, 56, 31}}, -- left main path
        ["Victory Road Kanto 2F_B"] = {{31, 23, 38, 27}}, -- middle, enclosed space
        ["Victory Road Kanto 2F_C"] = {{31, 28, 41, 31}}, -- middle, stairs
        ["Victory Road Kanto 2F_D"] = {{49, 11, 66, 20}, {60, 21, 65, 28}, {58, 29, 65, 31}}, -- right, path
    },
    ...
    ["Route 28"] = {
        ["Route 28_A"] = {{0, 23, 2, 30}, {3, 28, 9, 30}, {10, 15, 50, 30}, {51, 9, 60, 31}}, -- main part
        ["Route 28_B"] = {{0, 7, 42, 14}, {0, 15, 8, 21}, {3, 22, 9, 27}}, -- top
    },
    ["Mt. Silver 1F"] = {
        ["Mt. Silver 1F_A"] = {{25, 59, 45, 62}, {46, 47, 57, 62}}, -- main entrance
        ["Mt. Silver 1F_B"] = {{35, 16, 52, 46}, {31, 42, 34, 42}, {32, 41, 34, 41}, {44, 47, 44, 51}, {53, 42, 57, 44}}, -- main path pre rock smash
        ["Mt. Silver 1F_C"] = {{18, 34, 30, 42}, {31, 35, 31, 39}, {21, 43, 31, 47}, {21, 48, 41, 54}}, -- main path post rock smash
        ["Mt. Silver 1F_D"] = {{17, 19, 26, 29}}, -- top left
        ["Mt. Silver 1F_E"] = {{54, 21, 60, 31}}, -- top right
    },
    ["Mt. Silver 2F"] = {
        ["Mt. Silver 2F_A"] = {{14, 17, 46, 47}, {14, 14, 33, 16}, {14, 48, 30, 50}}, -- main part
        ["Mt. Silver 2F_B"] = {{34, 15, 49, 16}, {49, 17, 51, 31}}, -- top right
        ["Mt. Silver 2F_C"] = {{49, 32, 51, 47}}, -- bottom right
        ["Mt. Silver 2F_D"] = {{31, 48, 50, 51}}, -- bottom
    },
    ["Mt. Silver Upper Mountainside"] = {
        ["Mt. Silver Upper Mountainside_A"] = {{22, 21, 41, 43}}, -- first path, towards red
        ["Mt. Silver Upper Mountainside_B"] = {{0, 49, 41, 63}}, -- second path, towards red
    },
    ["Route 26"] = { -- double crossed parts : water and bridge -- not supported 100%
        ["Route 26_A"] = {{0, 116, 17, 118}, {18, 114, 24, 118}, {21, 100, 23, 113}, {20, 93, 32, 99}, {17, 83, 34, 88}, {29, 88, 34, 92}, {0, 0, 35, 82}}, -- main part
        ["Route 26_B"] = {{0, 84, 15, 100}, {16, 90, 25, 92}, {0, 102, 20, 114}, {4, 115, 17, 115}, {0, 119, 17, 122}, {24, 102, 27, 113}}, -- bottom left
    },
    ["Saffron City Station"] = {
        ["Saffron City Station_A"] = {{0, 9, 32, 20}}, -- main part, towards saffron
        ["Saffron City Station_B"] = {{1, 3, 13, 8}}, -- secondary part, towards F2
    },
    ["Route 8"] = {
        ["Route 8_A"] = {{3, 3, 33, 20}, {34, 3, 43, 9}, {44, 3, 72, 20}}, -- outside, path
        ["Route 8_B"] = {{34, 10, 43, 20}}, -- middle, grass
    },
   ["Safari Entrance"] = {
        ["Safari Entrance_A"] = {{3, 19, 14, 29}, {15, 18, 26, 26}, {27, 16, 34, 28}, {35, 12, 55, 29}}, -- bottom part
        ["Safari Entrance_B"] = {{0, 4, 21, 16}, {22, 16, 26, 16}}, -- top left part
        ["Safari Entrance_C"] = {{22, 3, 34, 15}, {35, 3, 51, 10}}, -- top right part
    },
    ["Safari Area 2"] = {
        ["Safari Area 2_A"] = {{6, 27, 11, 44}, {12, 19, 16, 44}, {17, 18, 21, 42}, {22, 16, 43, 42}}, -- bot part
        ["Safari Area 2_B"] = {{5, 5, 38, 15}, {6, 16, 16, 18}, {7, 19, 11, 26}}, -- top part
    },
    ["Safari Effort Wald 2"] = {
        ["Safari Effort Wald 2_A"] = {{2, 7, 15, 29}, {16, 10, 17, 25}, {17, 5, 28, 15}, {23, 16, 29, 17}, {24, 18, 29, 18}, {255, 19, 26, 19}}, -- left
        ["Safari Effort Wald 2_B"] = {{31, 8, 47, 38}, {17, 20, 30, 33}, {16, 26, 17, 30}, {18, 16, 22, 19}, {23, 18, 23, 18}, {23, 19, 24, 19}, {27, 19, 29, 19}}, -- right
    },
    ["Cinnabar mansion 1"] = {
    ...
    ["Cinnabar mansion 3"] = {
        ...
        ["Cinnabar mansion 3_B"] = {{1, 3, 15, 8}, {16, 3, 37, 26}}, -- main paths
    },
    ["Cinnabar mansion B1F"] = {
        ["Cinnabar mansion B1F_A"] = {{1, 16, 9, 22}}, -- left closed by guards
        ["Cinnabar mansion B1F_B"] = {{1, 3, 11, 15}, {1, 26, 11, 32}, {12, 3, 37, 32}}, -- main map
    },
    ["Route 13"] = {
        ["Route 13_A"] = {{6, 9, 73, 34}, {74, 21, 98, 28}, {91, 0, 98, 20}}, -- main road
        ["Route 13_B"] = {{74, 12, 87, 20}}, -- small grass patch
    },
    ["Route 14"] = {
...
----------------------
    ...
    ["Route 115"] = {
        ...
        ["Route 115_C"] = {{11, 76, 40, 77}, {10, 5, 44, 75}, {45, 1, 57, 28}, {58, 7, 65, 32}}, -- top
